...
<body>
    ...
    <div class="container">
        ...
        <div class="search-bar">
            <input type="text" id="commentSearch" placeholder="Search post comments..." onkeyup="searchComments()">
        ...
        <table id="commentTable">
            <thead>
                <tr>
                    ...
                    <th class="sortable" onclick="sortTable(3)">Post</th>
                    <th>Actions</th>
                </tr>
            </thead>
            <tbody>
    ...
    <script>
        ...
        document.getElementById('confirmDeleteBtn').addEventListener('click', function() {
            if (commentIdToDelete) {
                ...
                fetch(`/admin/post-comments/${commentIdToDelete}`, {
                        method: 'DELETE',
                        headers: {
