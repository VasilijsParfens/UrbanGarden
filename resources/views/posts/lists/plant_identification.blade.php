...
<head>
    ...
    <style>
        ...
        .request-identification-btn:hover,
        .create-btn:hover {
...
<body>
    ...
    <div class="container">
        ...
        <form method="GET" action="{{ route('posts.lists.show', ['type' => 'plant_identification']) }}" class="filter-bar">
            <div class="filters">
                <input type="text" name="search" placeholder="Search Identifications..." value="{{ request('search') }}">
            </div>
        ...
        <!-- Create Button -->
        <a href="{{ route('posts.create', ['type' => 'plant_identification']) }}" class="create-btn">Create New Post</a>

        <div class="grid-container" id="identificationGrid">
                ...
                @if ($post->type === 'plant_identification')
                    <div class="identification-card">
                        ...
                        <div class="card-content">
                            ...
                            <a href="{{ route('posts.show', $post->id) }}" class="view-btn"><i class="fas fa-eye"></i> View Identification</a>
                        </div>
                    </div>
                @endif
            @empty
                <p class="no-identifications" style="text-align: center; font-size: 16px; color: #666;">
